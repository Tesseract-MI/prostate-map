  ...
  render() {
    ...
    >
      ...
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.cz} direction={directions.right} onClick={this.props.onZoneChange} x={530.049} y={297.968} fontSize={8.872}>
          {'CZ'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.cz} direction={directions.left} onClick={this.props.onZoneChange} x={597.241} y={297.118} fontSize={8.872}>
          {'CZ'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.tza} direction={directions.right} onClick={this.props.onZoneChange} x={531.403} y={244.629} fontSize={8.872}>
          {'TZa'}
        </tspan>
      </text>
      <path
      ...
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.tza} direction={directions.left} onClick={this.props.onZoneChange} x={591.96} y={244.574} fontSize={8.872}>
          {'TZa'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.pza} direction={directions.left} onClick={this.props.onZoneChange} x={639.159} y={260.721} fontSize={8.872}>
          {'PZa'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.pzpl} direction={directions.left} onClick={this.props.onZoneChange} x={632.713} y={294.08} fontSize={8.872}>
          {'PZpl'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.tzp} direction={directions.left} onClick={this.props.onZoneChange} y={273.035} x={595.849} fontSize={8.872}>
          {'TZp'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.tzp} direction={directions.right} onClick={this.props.onZoneChange} x={533.093} y={273.035} fontSize={8.872}>
          {'TZp'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.pza} direction={directions.right} onClick={this.props.onZoneChange} y={260.838} x={486.071} fontSize={8.872}>
          {'PZa'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.pzpl} direction={directions.right} onClick={this.props.onZoneChange} x={490.137} y={294.425} fontSize={8.872}>
          {'PZpl'}
        </tspan>
      </text>
      <text
      ...
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan y={213.693} x={552.97} fontSize={8.872}>
          {'AS'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.as} direction={directions.left} onClick={this.props.onZoneChange} x={576.658} y={213.693} fontSize={8.872}>
          {'AS'}
        </tspan>
      </text>
      <text
        ...
        transform="translate(-478.83 -202.253)"
      >
        <tspan zone={zones.as} direction={directions.right} onClick={this.props.onZoneChange} x={552.97} y={213.693} fontSize={8.872}>
          {'AS'}
        </tspan>
      </text>
