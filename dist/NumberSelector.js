...
function (_Component) {
  ...
  function NumberSelector(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NumberSelector).call(this, props));
    _this.state = {
      value: '3'
    };
  ...
  _createClass(NumberSelector, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "prostate-zone-selector-number-selector"
      }, _react.default.createElement("label", null, this.props.label), _react.default.createElement("select", {
...
_defineProperty(NumberSelector, "propTypes", {
